...
if [ "$1" = "sla_benchmark" ]; then
    ...
    test_benchmark_serving_request_rate 256 256 800 1.0 $num_of_p_node
    ...
    test_benchmark_serving_request_rate 1024 256 240 1.0 $num_of_p_node
    test_benchmark_serving_request_rate 1024 256 256 1.0 $num_of_p_node
    ...
    test_benchmark_serving_request_rate 1024 1024 640 1.0 $num_of_p_node
    ...
    test_benchmark_serving_request_rate 8192 1024 128 1.0 $num_of_p_node
